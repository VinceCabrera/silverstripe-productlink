!function (n) {
    ...
    }, e.p = "", e(e.s = "./client/dist/js/TinyMCE_sslink-pcw.js")
}({
    "./client/dist/js/TinyMCE_sslink-pcw.js": function (n, e, t) {
        "use strict";
        ...
        t("./client/src/lang/en.js"), t("./client/src/lang/fr.js"), l.default.addAction("sslink", {
            text: o.default._t("Admin.LINKLABEL_PCW", "Link to PCW record"),
            onclick: function (n) {
                return n.execCommand("sslinkpcw")
            },
            priority: 51
        }).addCommandWithUrlTest("sslinkpcw", /^tel:/);
        var g = {
                init: function (n) {
                    n.addCommand("sslinkpcw", function () {
                        window.jQuery("#" + n.id).entwine("ss").openLinkPCWDialog()
                    })
                }
            }, _ = "insert-link__dialog-wrapper--pcw",
            L = (0, h.loadComponent)((0, m.createInsertLinkModal)("SilverStripe\\Admin\\LeftAndMain", "EditorPCWLink"));
        p.default.entwine("ss", function (n) {
            n("textarea.htmleditor").entwine({
                openLinkPCWDialog: function () {
                    var e = n("#" + _);
                ...
                renderModal: function (n) {
                    ...
                    c.default.render(d.default.createElement(L, {
                        ...
                        onInsert: i,
                        onClosed: t,
                        title: o.default._t("Admin.LINK_PCW", "Insert PCW link"),
                        bodyClassName: "modal__dialog",
                        className: "insert-link__dialog-wrapper--pcw",
                        fileAttributes: r,
                        identifier: "Admin.InsertLinkPCWModal",
                        requireLinkText: u
                    }), this[0])
